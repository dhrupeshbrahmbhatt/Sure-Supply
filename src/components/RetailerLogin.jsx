...
import { RiStoreLine, RiSecurePaymentFill } from 'react-icons/ri';
...
const RetailerLogin = () => {
  ...
  const features = [
    {
      ...
      description: "Access predictive insights for inventory management"
    },
    {
      icon: <RiSecurePaymentFill size={32} />,
      title: "Waste Prevention",
      description: "Track and optimize your waste reduction efforts"
    },
    {
      icon: <IoSpeedometer size={32} />,
      title: "NGO Partnerships",
      description: "Connect with local organizations for food donation"
    }
  ];
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/retailer/login', {
        method: 'POST',
      ...
      if (response.ok) {
        toast.success('Welcome back to your dashboard! 🌟', { id: loadingToast });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3000/retailer/${endpoint}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
            ...
            <div className="relative p-10 h-full flex flex-col justify-center">
              <motion.div variants={itemVariants}>
                <h1 className="text-5xl font-extrabold text-emerald-50 mb-6 leading-tight">
                  Welcome Back to<br />Smart Inventory
                </h1>
                <p className="text-emerald-100/80 text-lg mb-12">
                  Continue optimizing your business sustainability
                </p>
              </motion.div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h3 className="font-semibold">Reset via Business Email</h3>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Get an OTP on your registered phone</p>
                        </div>
                      </div>
                    </motion.button>
                    ...
                    <motion.div variants={itemVariants}>
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder={resetMethod === 'email' ? 'Business Email' : 'Phone Number'}
